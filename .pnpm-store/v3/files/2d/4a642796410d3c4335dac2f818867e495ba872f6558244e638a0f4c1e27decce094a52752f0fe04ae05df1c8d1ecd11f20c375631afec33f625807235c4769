(function (factory) {
    ...
    exports.isModuleOrNamespace = exports.updateSymbolMapping = exports.createChildReflection = exports.removeReflection = exports.removeTags = exports.isTypedocVersion = void 0;
